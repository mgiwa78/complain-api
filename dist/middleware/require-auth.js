...
const AuthenticateUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userData = yield user_1.User.findById(decoded.user._id).populate("roles");
        if (userData) {
            req.user = Object.assign({ isAdmin: userData.role === "admin", id: decoded.user._id, role: userData.role }, userData);
        }
        else {
